        ...
        <>
            <Spin spinning={loading}>
                <Card
                    key={`map${item.id}`}
                    cover={
                        <img src={`${process.env.NEXT_PUBLIC_MAPBOX_API_URL}/styles/v1/mbshaban/${item.styleId}/static/-87.0186,32.4055,10/280x250?access_token=${process.env.NEXT_PUBLIC_MAPBOX_TOKEN}`} alt={item.name} />
                    }
