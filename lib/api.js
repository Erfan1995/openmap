...
export async function getMapAnalytics(mapId, token) {
  try {
    const data = await fetchAPIGraphQl(`
  query Posts($where: JSON)
      {
...
export async function getOneMap(id, token, status = null) {
  try {
    const data = await fetchAPIGraphQl(`
  query Posts($where: JSON)
      {
...
export async function getMMDPublicUser(mapId, token, status = null) {
  try {
    const data = await fetchAPIGraphQl(`
  query Posts($where: JSON)
      {
...
export async function getMMDCustomersClients(condition, token, status = null) {
  try {
    const data = await fetchAPIGraphQl(`
  query Posts($where: JSON)
      {
...
export async function getDatasetsByMap(mapId, token) {
  try {
    const data = await fetchAPIGraphQl(`
  query Posts($where: JSON)
      {
...
export async function getMapPopupProperties(id, token) {
  try {
    const data = await fetchAPIGraphQl(`
  query Posts($where: JSON)
      {
...
export async function postPublicUserFileMethod(url, data) {
  // const { token } = nookies.get();
  const res = await fetch(`${strapiUrl}/${url}`, {
    method: 'POST',
    headers: {
